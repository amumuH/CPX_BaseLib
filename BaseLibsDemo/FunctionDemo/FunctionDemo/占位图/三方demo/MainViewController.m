...
@interface MainViewController () <DZNEmptyDataSetSource, DZNEmptyDataSetDelegate,UITableViewDataSource,UITableViewDelegate>
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.rightBarButtonItem = [UIBarButtonItem cpx_itemWithTarget:self action:@selector(respontoTest) title:@"测试"];
}
//测试按钮
-(void)respontoTest{
    EmptyTestViewController *vc = [EmptyTestViewController new];
